...
export default (props) => {
  ...
  const pessoal = props.pessoalController.pessoalValues.pessoal;
  const setPessoal = props.pessoalController.pessoalValues.setPessoal;
  const pessoalError = props.pessoalController.pessoalErrors.pessoalError;
  const setPessoalError = props.pessoalController.pessoalErrors.setPessoalError;
