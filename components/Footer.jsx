...
export default props => {
    ...
    return (
        <>
            <div className={props.menuController.isOpen ? styles.footerNone : styles.footer}>
                <div>
                    <Image src={curriculumImg}
                        ...
                        height={48}
                    />
                    <span style={{ fontSize: "48px", color: "#2C4ECA", fontWeight: "700" }}>Jobs-103</span>
                </div>
