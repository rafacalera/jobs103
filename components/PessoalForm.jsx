...
export default ({ submitController, pessoalController, proximoEstagio }) => {
  const pessoal = pessoalController.pessoal;
  const setPessoal = pessoalController.setPessoal;
  const pessoalError = pessoalController.pessoalError;
